...
print("""
    ...
    on https://play2048.co imitating a human player such as yourself by sending actual swipes to the game.

    Try it out and see how far you can go before you run out of moves to make! Haha
""")
...
swipes=int(input('Amount of swipes: '))
...
try:
    ...
    print(e)
    print('Oops! The error(s) above as shown occured, please correct them and try again.')
